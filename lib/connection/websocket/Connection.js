...
// 			if (_window.WebSocket) {
			...
			//use HTML5 websocket, or fallback to node
			// websocket ws library https://github.com/websockets/ws
			const myWebSocketInstance=typeof window != 'undefined'?window.WebSocket:WebSocket

			if (myWebSocketInstance) {
